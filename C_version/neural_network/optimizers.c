...
weight_bias gradient_descent_delta(neural_network* layer, matrix error, double learning_rate, matrix previous_values, double l1, double l2){
    weight_bias result;
    matrix multiplied = matrix_copy(error);
    matrix_multiply_by_constant(multiplied, learning_rate);
...
void gradient_descent_dual(neural_network* original_layer, neural_network* changed_layer,matrix error, double learning_rate, matrix previous_values, double l1, double l2){
    matrix multiplied = matrix_copy(error);
    matrix_multiply_by_constant(multiplied, learning_rate);
